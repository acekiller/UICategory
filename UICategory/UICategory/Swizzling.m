...
void swizzleSelector(Class clazz, SEL orgSel, SEL swizzingSel)
{
    ...
    if (class_addMethod(clazz, orgSel, method_getImplementation(swizzing_method),
                        method_getTypeEncoding(org_method)))
    {
        class_replaceMethod(clazz, swizzingSel,
                            method_getImplementation(org_method),
                            method_getTypeEncoding(org_method));
    } else {
...
//    IMP origIMP = method_getImplementation(org_method);
    ...
    if (class_addMethod(clazz, orgSel, swizzingIMP,
                        method_getTypeEncoding(org_method)))
    {
