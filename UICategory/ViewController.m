...
//                                                              multiplier:1.f constant:10.f];
    ...
    NSLog(@"t.constraints : %@",t.constraints);
    t.numberOfLines = 0;
    t.lineBreakMode = NSLineBreakByWordWrapping;
    t.backgroundColor = [UIColor redColor];
    CGFloat ediSize = 10.f;
    t.cornerRadius = 5.f;
    t.text = @"测试[emoji_00],欢迎。[emoji_01],测试内容[emoji_02],哈哈[emoji_03],难啊。你猜猜，我猜猜，大家都不知道，这是怎么回事儿。那该咋办呢？3.2遗留：一个孩子的家长可以相互看到手机号。028-64566560";
